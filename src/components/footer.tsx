  ...
  return (
    <footer className="bg-primary text-primary-foreground">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-12 md:grid-cols-4 md:px-6">
        ...
        <FooterLinks title="Nos Marques" links={[["Produits Sika", "/produits-sika-algerie-distributeur-agree-naf-factory/"], ["Produits Terraco", "/produits?marque=terraco"], ["Produits Lafarge", "/produits?marque=lafarge"], ["Produits BASF", "/produits?marque=basf"], ["Produits Decor Boya", "/produits?marque=decor-boya"], ["Produits Proseal", "/produits?marque=proseal"], ["Produits Victo", "/produits?marque=victo"]]} />
